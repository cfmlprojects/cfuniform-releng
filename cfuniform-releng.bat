...
cls
echo.
echo       cfUniForm-releng menu
REM echo       usage: cfUniForm-releng.bat [start|stop|{target}]
echo.
...
echo to stop the server, run this again or run: cfUniForm-releng.bat stop
goto end
::
:stopServer
